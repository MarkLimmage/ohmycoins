# IAM Module for Oh My Coins
# Creates IAM roles and policies for ECS tasks and GitHub Actions deployment
...
# Additional policy for pulling secrets from Secrets Manager
...
# Application policy for the ECS task
...
# OIDC Provider for GitHub Actions (if needed)
