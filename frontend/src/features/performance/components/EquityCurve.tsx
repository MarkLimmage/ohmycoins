...
export const EquityCurve: React.FC<EquityCurveProps> = ({ data }) => {
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 border border-gray-200 dark:border-gray-700 h-[400px]">
       <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100 mb-4">Equity Curve</h3>
      <div className="w-full h-[300px]">
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            />
            <Tooltip 
              contentStyle={{ backgroundColor: '#1f2937', color: '#f3f4f6', borderRadius: '0.375rem', border: 'none' }}
