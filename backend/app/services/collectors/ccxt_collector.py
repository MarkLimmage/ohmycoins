...
class CCXTCollector(BaseCollector):
    ...
    def __init__(self, exchanges: List[str] = None, symbols: List[str] = None):
    ...
    async def collect(self) -> Dict[str, Any]:
        ...
        Returns a dictionary keyed by exchange name containing lists of OHLCV data.
        """
        results = {}
    ...
    async def store_data(self, data: Dict[str, Any], session: Session) -> int:
        """
        Store collected OHLCV data into ExchangeOHLCV table.
        """
        count = 0
        for exchange_name, records in data.items():
