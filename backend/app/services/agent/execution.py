...
class SandboxExecutor:
    ...
    async def execute_code(self, code: str, data_path: str = None) -> dict:
        """
        Run code in sandbox.
        ...
        async with dagger.Connection(dagger.Config(log_output=sys.stderr)) as client:
            ...
            if data_path:
                container = container.with_mounted_file("/workspace/data.parquet", client.host().file(data_path))
...
{code}
            ...
            container = (
                container
                .with_new_file("/workspace/script.py", contents=script_content)
